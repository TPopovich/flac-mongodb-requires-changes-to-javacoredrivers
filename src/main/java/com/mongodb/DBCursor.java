...
/*
 * DBCursor - re-Created to change various private items to protected to properly extend.
 */
...
public class DBCursor implements Cursor, Iterable<DBObject> {
     ...
     */
    protected static enum CursorType {
        ITERATOR, ARRAY
    }
    ...
    // ----  result info ----
    protected QueryResultIterator _it = null;
